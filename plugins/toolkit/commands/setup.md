...
4. Create worktree in sibling directory: `../<project>-wip`
...
- WORKTREE_PATH = ../${PROJECT_NAME}-wip
...
- The worktree path where work should happen
- The branch name created
- Remind them to cd into the worktree or point agents there
