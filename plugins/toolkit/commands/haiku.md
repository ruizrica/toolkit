...
3. **USE HAIKU MODEL**: All spawned agents MUST use `model: "haiku"`
...
```
Task 1: { subagent_type: "Explore", model: "haiku", prompt: "You are Context Agent 1 - Code Explorer. Task: [user task]. Find relevant files, patterns, similar implementations. Return JSON: {agent, role, findings, recommendations}" }

Task 2: { subagent_type: "Explore", model: "haiku", prompt: "You are Context Agent 2 - Architecture Scout. Task: [user task]. Map dependencies, entry points, module structure. Return JSON: {agent, role, findings, recommendations}" }

Task 3: { subagent_type: "Explore", model: "haiku", prompt: "You are Context Agent 3 - History Investigator. Task: [user task]. Check git history, recent changes, ownership. Return JSON: {agent, role, findings, recommendations}" }

Task 4: { subagent_type: "Explore", model: "haiku", prompt: "You are Context Agent 4 - Test Analyst. Task: [user task]. Find test patterns, coverage gaps, quality requirements. Return JSON: {agent, role, findings, recommendations}" }
```
