#!/usr/bin/env python3
# ABOUTME: Persistent mini-REPL for RLM (Recursive Language Model) workflows.
# ABOUTME: Maintains state across invocations via pickle for chunking and analyzing large documents.
