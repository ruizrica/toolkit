<p align="center">
  <img src="../../assets/haiku.png" alt="Haiku" width="120">
</p>

# /haiku

Spawn a team of 10 Haiku agents managed by Opus for any task. This command provides structured multi-agent orchestration with distinct phases for context gathering, implementation, and validation.

## Usage

```bash
/haiku [task description - research, analyze, implement, etc.]
```
...
|----------|----------|-------------|
| task description | Yes | The task for the Haiku team (research, analyze, implement, etc.) |
...
| Context Haikus | 4 | Gather context before implementation |
| Implementation Haikus | 4 | Execute the main work in parallel |
| Validator Haikus | 2 | Verify and cross-check results |

## How It Works

### Phase 1: Context Gathering

Four Haiku agents launch in parallel to gather context:
...
Four Haiku agents launch in parallel with roles based on task type:
...
Two Haiku agents verify the work:
...
- **Cost-Effective** - Uses Haiku model for all sub-agents

## When to Use

- Tasks benefiting from multiple perspectives
- Research requiring thorough exploration
- Implementation needing validation
- Analysis tasks requiring cross-checking
